...
const HomePage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const serviceId = "service_e6lvw4q";
    const templateId = "template_3w1xsp4";
    const publickKey = "Hg3X9apcwwur0qm-a";
    ...
    <div>
      <header className="header" data-header>
        ...
        <div className="whatsapp-icon">
          <a
            style={{ textDecoration: "none", color: "white" }}
            href="https://api.whatsapp.com/send/?phone=+91 9623166116&amp;text=Thank+You+For+Your+Valuable+Enquiry+Your+Requirement+Is+Top+Most+Priority+For+Us.+Our+Booking+Team+Will+Assist+You+Shortly%21+You+Can+Contact+Us+on+ 9623166116+%2F++91 9623166116"
          >
        ...
        <div className="header-top" style={{ backgroundColor: "white" }}>
          <div className="container">
            ...
            >
              <div>
                <div style={{ display: "flex", flexDirection: "row" }}>
                  <a href="https://api.whatsapp.com/send/?phone=+91 9623166116&amp;text=Thank+You+For+Your+Valuable+Enquiry+Your+Requirement+Is+Top+Most+Priority+For+Us.+Our+Booking+Team+Will+Assist+You+Shortly%21+You+Can+Contact+Us+on+ 9623166116+%2F++91 9623166116">
                    <img
            ...
            <a href="#" className="logo">
              ...
              {/* <p style={{color:"white"}}>Mahalakshmi tours ad travels</p> */}
            </a>
          ...
          <section class="popular" id="about">
            <div className="container">
              ...
              <div>
                ...
                <h4>WHY CHOOSE MAHALAKSHMI CABS ?</h4>
                <ul>
                  <li>✅ Customer security and safety is guaranteed. </li>
                  <li>✅ Mahalakshmi Cabs provides Free Masks for passengers</li>
                  <li>
              ...
              <div>
                ...
                >
                  ...
                  <div>
                    <p style={{ color: "black" }} className="section-text">
                      ABOUT{" "}
                      <b style={{ color: "red" }}>MAHALAKSHMI CAB SERVICES</b>
                    </p>
                    <p style={{ color: "black" }} className="section-text">
                      We offer best cab services in Maharashtra.
                    </p>
          ...
          <section className="cta" id="cabservice">
            ...
            >
              <ul>
                ...
                <li>🔴 Pune to Goa</li>
                <li>🔴 Pune to Lavasa</li>
                <li>🔴 Pune to Bhimashankar</li>
              </ul>
              <ol>
                <b style={{ color: "red" }}>Services</b>
                <br />
        ...
        <div className="footer-top">
          <div className="container">
            <div className="footer-brand">
              <a href="#" className="logo">
                <p style={{ fontSize: "35px", color: "red" }}>MAHALAKSHMI</p>
              </a>
            ...
            <div className="footer-contact">
              ...
              <ul>
                ...
                <li className="contact-item">
                  ...
                  <address>
                    New BRT Road, Near P.C.M.C School, Pawna Nagar, Kalewadi
                    Pune - 411017
                  </address>
                </li>
              </ul>
        ...
        <div className="footer-bottom">
          <div className="container">
            <p className="copyright">
              &copy; 2024 <a href="">Mahalakshmi</a>. All rights reserved
            </p>
